...
export default function Navbar() {
  ...
  // mobile menu open হলে body scroll বন্ধ
  useEffect(() => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
      scrolled ? 'bg-brand-dark/95 backdrop-blur-md py-4 border-b border-gray-800 shadow-xl' : 'bg-transparent py-6 border-b border-transparent'
    }`}>
