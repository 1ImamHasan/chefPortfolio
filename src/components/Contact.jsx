        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div className="bg-[#1f1f1f] p-10 rounded-lg border border-gray-800 shadow-2xl" data-aos="fade-left">
            <form action="https://formspree.io/f/mqazqozk" method="POST" className="space-y-6">
              ...
              <button type="submit"
                className="w-full bg-brand-gold text-white font-sans font-bold uppercase tracking-widest py-4 hover:bg-amber-700 transition-colors text-xs rounded-sm shadow-lg">
                Send Message
              </button>
            </form>
          </div>
