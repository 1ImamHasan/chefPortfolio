  ...
  return (
    <>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className={`fixed bottom-36 md:bottom-24 right-6 p-4 bg-green-500 text-white rounded-full shadow-2xl z-40 hover:bg-green-600 transition-all duration-300 ${
